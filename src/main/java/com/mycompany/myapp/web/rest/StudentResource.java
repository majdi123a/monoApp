...
public class StudentResource {
     ...
     */
    @GetMapping("/students")
    public ResponseEntity<List<StudentDTO>> getAllStudents(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
