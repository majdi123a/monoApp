...
public class StudentResourceIT {
    ...
    private static final LocalDate DEFAULT_DATEOBIRTH = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_DATEOBIRTH = LocalDate.now(ZoneId.systemDefault());
    ...
    public void createStudent() throws Exception {
        ...
        assertThat(testStudent.getDateobirth()).isEqualTo(DEFAULT_DATEOBIRTH);
    }
    ...
    public void getAllStudents() throws Exception {
        ...
        restStudentMockMvc.perform(get("/api/students?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].dateobirth").value(hasItem(DEFAULT_DATEOBIRTH.toString())));
    }
    ...
    public void getStudent() throws Exception {
        ...
        restStudentMockMvc.perform(get("/api/students/{id}", student.getId()))
            ...
            .andExpect(jsonPath("$.dateobirth").value(DEFAULT_DATEOBIRTH.toString()));
    }
    ...
    public void updateStudent() throws Exception {
        ...
        assertThat(testStudent.getDateobirth()).isEqualTo(UPDATED_DATEOBIRTH);
    }
